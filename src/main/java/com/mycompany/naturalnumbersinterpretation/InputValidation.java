...
/**
 *The method isValid checks if the user's input 
 * consists of positive integers that have
 * maximum three digits
 * 
     * @param n is the user's input in
     * a String array
     * @return true if the input consists of positive integers 
     * that have maximum three digits
 */
...
/**
 *The method is MaximumThreeDigit checks if a String Array that
 * contains numeric Strings has elements with maximum three digits
